 ...
 <?php 
        ...
        ?>  
                    <tr class="success">    
                        ...
                        <td><a href="<?php echo site_url('start/u_category/'.$items->CATEGORYID)  ;?>"<?php if($active == 'category'){ echo 'class="active"'; } ?>>Edit</a> | 
                            <a href="#" id="<?php echo $items->CATEGORYID;?>" class="categoryDelete">Delete</a>
                        </td>
